...
class MainWPRemoteDestinationUploadTracker
{
    ...
    public function track_upload($file, $uploadID, $offset, $useStartOffset = false)
    {
        ...
        if (!isset($array[$this->uniqueId]) || ($array[$this->uniqueId] < $offset))
        {
            $array[$this->uniqueId] = $offset;
        }
